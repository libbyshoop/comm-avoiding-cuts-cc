...
#Usage: ./mc_test_rr_mac.sh GRAPH.in MAX_PROCS > OUTPUT.txt 
...
do
	...
	do
		...
		#We opt to NOT use round robin in with the min cuts. (This script is for 
		#testing the difference between rr and without). This better utilizes
		...
		mpirun -f /media/cluster_files/cluster_nodes_rr -np ${proc_count} ../../../src/executables/square_root 0.9 ${input} ${seed}
