...
#Usage: ./mc_dense_rmat_runner_mac.sh INPUT_DIR OUTPUT_DIR HOST_FILE MAX_PROCS
...
do
	...
	./mc_test_mac.sh ${input_dir}/rmat_${size}_${edges}.in ${host_file} ${max_procs} > ${output_dir}/mc_rmat_${size}_${edges}.txt
