...
# Usage: ./rmat_driver.sh vertices edges threads > output_dir/graphname.in
...
PaRMAT -nVertices ${vertices} -nEdges ${edges} -memUsage 0.9 -noEdgeToSelf -noDuplicateEdges -threads ${threads} 1>&2
